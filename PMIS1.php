				  ...
				  $notupdated=$dmssumCount-$dmssumCount1;
				   if($v<=$countryCountd)
                    ...
                    <tr>
                      ...
                      <td id="td-data"><span ><?php  echo $dmssumCount1;?></span></td>
                       <td id="td-data"><span ><?php echo $notupdated;?></span></td>
                    </tr>
                    <?php
					$v++;
                   ...
                   <tr>
                      ...
                      <td id="td-data"><span ><?php  echo $dms_total_updated;?></span></td>
                       <td id="td-data"><span ><?php echo $dms_total_nupdated;?></span></td>
                    </tr>
				  ...
				  $notupdated=$gissumCount-$gissumCount1;
				   if($w<=$countryCountd)
                    ...
                    <tr>
                      ...
                      <td id="td-data"><span ><?php  echo $gissumCount1;?></span></td>
                       <td id="td-data"><span ><?php echo $notupdated;?></span></td>
                    </tr>
                    <?php
					$w++;
                   ...
                   <tr>
                      ...
                      <td id="td-data"><span ><?php  echo $gis_total_updated;?></span></td>
                       <td id="td-data"><span ><?php echo $gis_total_nupdated;?></span></td>
                    </tr>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th id="th-abcd">Project Name</th>
                     <th id="th-abcd">Country</th>
                    <th id="th-abcd">Link</th>
                    <th id="th-abcd">News</th>
                    <th id="th-abcd">Pictorial</th>
                     <th id="th-abcd">Drawing</th>
                    <th id="th-abcd">Issue</th>
                    <th id="th-abcd">RFI</th>
                    <th id="th-abcd">Daily Observation</th>
                    <th id="th-abcd">Weekly Observation</th>
                    <th id="th-abcd">NCR</th>
                    <th id="th-abcd">Incident</th> 
                     <th id="th-abcd">IPC</th>
                     <th id="th-abcd">Activity</th>
                    <th id="th-abcd">XER</th>
                    <th id="th-abcd">Project</th>
                    <th id="th-abcd">Slider</th>
                    <th id="th-abcd">Photo</th>
                    <th id="th-abcd">Video</th>
                    <th id="th-abcd">Non_Conformity</th>
                    <th id="th-abcd">Pictorial View</th>
                    <th id="th-abcd">Land Acquisition</th>
                   <th id="th-abcd">Utility</th>
                  </tr>
                  </thead>
                  <tbody>
