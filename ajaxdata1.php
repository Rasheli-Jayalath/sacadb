...
//else if(!empty($_POST["sid"])&& $_POST["sid"]!=0 && $_POST["sid"]!="" &&  $_POST["sid"]!="undefined" && !empty($_POST["cid"])&& $_POST["cid"]!=0 && $_POST["cid"]!="" &&  $_POST["cid"]!="undefined" && !empty($_POST["Project_Type"]) && $_POST["Project_Type"]!=0 && $_POST["Project_Type"]!="" &&  $_POST["Project_Type"]!="undefined"){ 
 if(!empty($_POST["sid"])&&!empty($_POST["cid"])&& $_POST["Project_Type"]=="" && $_POST["Status"]==""  ){ 
    $incListQuery  = "select DISTINCT(smt.master_code)
                      FROM saca_project_master as smt Inner Join saca_profitability as sp
          ON smt.master_code = sp.project Where 1=1 AND smt.country = '".$_POST["cid"]."' AND smt.sector='".$_POST["sid"]."' order by  smt.pid ";
    ...
    if($incListCount > 0){ 
        ...
        while($incListRes = mysqli_fetch_assoc($incListResult)){  
            echo '<option value="'.$incListRes['master_code'].'">'.$incListRes['master_code'].'</option>'; 
        } 
    }else{ 
    ...
    $incListQuery  = "select DISTINCT(smt.master_code)
                      FROM saca_project_master as smt Inner Join saca_profitability as sp
          ON smt.master_code = sp.project Where 1=1 AND smt.country = '".$_POST["cid"]."' AND smt.sector='".$_POST["sid"]."' AND sp.Project_Type='".$_POST["Project_Type"]."' order by  smt.pid ";
    ...
    echo $incListQuery  = "select DISTINCT(smt.master_code)
                      FROM saca_project_master as smt Inner Join saca_profitability as sp
          ON smt.master_code = sp.project Where 1=1 AND smt.country = '".$_POST["cid"]."' AND smt.sector='".$_POST["sid"]."' AND sp.Project_Type='".$_POST["Project_Type"]."' AND sp.Status='".$_POST["Status"]."' order by  smt.pid ";
   ...
   $incListQuery  = "select DISTINCT(smt.master_code)
                      FROM saca_project_master as smt Inner Join saca_profitability as sp
          ON smt.master_code = sp.project Where 1=1 AND smt.country = '".$_POST["cid"]."'  order by  smt.pid ";
...
elseif(!empty($_POST["sid"]) && $_POST["sid"]!=0 && $_POST["sid"]!="" && $_POST["sid"]!="undefined" && (empty($_POST["cid"]) || $_POST["cid"]==0 || $_POST["cid"]=="" || $_POST["cid"]=="undefined") && (empty($_POST["Project_Type"]) || $_POST["Project_Type"]==0 || $_POST["Project_Type"]=="" || $_POST["Project_Type"]=="undefined" )){ 
   $incListQuery  = "select DISTINCT(smt.master_code)
                       FROM saca_project_master as smt Inner Join saca_profitability as sp
          ON smt.master_code = sp.project Where 1=1 AND smt.sector='".$_POST["sid"]."' order by  smt.pid ";
...
elseif(!empty($_POST["Project_Type"]) && $_POST["Project_Type"]!=0 && $_POST["Project_Type"]!="" && (empty($_POST["sid"]) || $_POST["sid"]==0 || $_POST["sid"]=="" || $_POST["sid"]=="undefined") && (empty($_POST["cid"]) || $_POST["cid"]==0 || $_POST["cid"]=="" || $_POST["cid"]=="undefined")){ 
   $incListQuery  = "select DISTINCT(smt.master_code)
                       FROM saca_project_master as smt Inner Join saca_profitability as sp
          ON smt.master_code = sp.project Where 1=1 AND sp.Project_Type='".$_POST["Project_Type"]."' order by  smt.pid ";
