  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php if(isset($totalProjectdata) && empty($singleProjectdata)){ echo "SACA DIVISION &raquo Fee Analysis (AUD)";}if(isset($singleProjectdata)){ echo 'Fee Analysis &raquo '.$singleProjectdata['project']." - ".$singleProjectdata['Project_Description'];}?>
            </h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Fee MTD (AUD)</h3>
          ...
          <div class="col-md-4">
             ...
             <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Fee YTD (AUD)</h3>
          ...
          <div class="col-md-4">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Fee LTD (AUD)</h3>
          ...
          <div class="col-12">
            <div class="card" >
              <div class="card-header"  style="background-color: #79a9ce; color: white; ">
                <h3 class="card-title"><bold><?php if(isset($totalProjectdata) && empty($singleProjectdata)){ echo "SACA DIVISION &raquo Fee MTD (AUD)";}if(isset($singleProjectdata)){ echo $singleProjectdata['project']." - ".$singleProjectdata['Project_Description'].'&raquo Fee MTD';}?></bold></h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-head-fixed text-nowrap">
                  <thead>
                    <tr>
                      <th align="center">Fees MTD</th>
                      <th align="center">Reimb MTD</th>
                      <th align="center">Total Rev MTD</th>
                      <th align="center">Salary MTD</th>
                      <th align="center">Reim Cost MTD</th>
                      <th align="center">Total Cost MTD</th>
                      <th align="center">Contrib MTD</th>
                      <th align="center">Cont Margin MTD</th>
                    </tr>
                  </thead>
                  <tbody>
                     <tr>
                        <td  ><?php echo number_format($totalProjectdata['sum_Fees_MTD'],0); ?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Reimb_MTD'],0); ?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Total_Rev_MTD'],0); ?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Salary_MTD'],0);?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Reim_Cost_MTD'],0);?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Total_Cost_MTD'],0);?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Contrib_MTD'],0);?></td>
                        <td  ><?php 
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #1d3a67; color: white; ">
                <h3 class="card-title"><bold><?php if(isset($totalProjectdata) && empty($singleProjectdata)){ echo "SACA DIVISION &raquo Fee YTD (AUD)";}if(isset($singleProjectdata)){ echo $singleProjectdata['project']." - ".$singleProjectdata['Project_Description'].'&raquo Fee YTD';}?></bold></h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-head-fixed text-nowrap">
                  <thead>
                    <tr>
                      <th align="center">Fees YTD</th>
                      <th align="center">Reimb YTD</th>
                      <th align="center">Total Rev YTD</th>
                      <th align="center">Salary YTD</th>
                      <th align="center">Reim Cost YTD</th>
                      <th align="center">Total Cost YTD</th>
                      <th align="center">Contrib YTD</th>
                      <th align="center">Cont Margin YTD</th>
                    </tr>
                  </thead>
                  <tbody>
                     <tr>
                        <td><?php echo  number_format($totalProjectdata['sum_Fees_YTD'],0);?></td>
                        <td><?php echo  number_format($totalProjectdata['sum_Reimb_YTD'],0); ?></td>
                        <td><?php echo  number_format($totalProjectdata['sum_Total_Rev_YTD'],0); ?></td>
                        <td><?php echo  number_format($totalProjectdata['sum_Salary_YTD'],0);?></td>
                        <td><?php echo  number_format($totalProjectdata['sum_Reim_Cost_YTD'],0);?></td>
                        <td><?php echo  number_format($totalProjectdata['sum_Total_Cost_YTD'],0); ?></td>
                        <td><?php echo  number_format($totalProjectdata['sum_Contrib_YTD'],0); ?></td>
                        <td><?php if($totalProjectdata['sum_Fees_YTD']!=0)
						{ 
						echo number_format($totalProjectdata['sum_Contrib_YTD']/$totalProjectdata['sum_Fees_YTD']*100,2);
						} 
						else
						{
						echo "0.00";
         ...
         <div class="row">
           <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #79a9ce; color: white; ">
                <h3 class="card-title"><bold><?php if(isset($totalProjectdata) && empty($singleProjectdata)){ echo "SACA DIVISION &raquo Fee LTD (AUD)";}if(isset($singleProjectdata)){ echo $singleProjectdata['project']." - ".$singleProjectdata['Project_Description'].'&raquoFee LTD';}?></bold></h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-head-fixed text-nowrap">
                  <thead>
                    <tr>
                      <th align="center">Fees LTD</th>
                      <th align="center">Reimb LTD</th>
                      <th align="center">Total Rev LTD</th>
                      <th align="center">Salary LTD</th>
                      <th align="center">Reim Cost LTD</th>
                      <th align="center">Total Cost LTD</th>
                      <th align="center">Contrib LTD</th>
                      <th align="center">Cont Margin LTD</th>
                    </tr>
                  </thead>
                  <tbody>
                     <tr>
                        <td  ><?php echo number_format($totalProjectdata['sum_Fees_LTD'],0); ?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Reimb_LTD'],0);?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Total_Rev_LTD'],0); ?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Salary_LTD'],0);?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Reim_Cost_LTD'],0);?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Total_Cost_LTD'],0);?></td>
                        <td  ><?php echo number_format($totalProjectdata['sum_Contrib_LTD'],0); ?></td>
                        <td  ><?php if($totalProjectdata['sum_Fees_LTD']!=0)
						{ 
