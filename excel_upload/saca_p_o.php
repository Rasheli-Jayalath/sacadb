...
<body>
<div class="container" style="width: 30%;  bg-color:red;">
	<h4>1 Upload tab2 (saca__project_profit) File</h4>
	<form id ="data1" method="POST" action="saca_acn.php" enctype="multipart/form-data">
...
$("form#data1").submit(function(e) {
    ...
    $.ajax({
        ...
        url: 'http://localhost/excel_upload_single_table/saca_p_o_acn.php',
