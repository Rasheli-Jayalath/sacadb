...
<div class="container" style="width: 90%;  bg-color:red;margin-top:10px">
	<h4 style="text-align:center;">Upload tab4 (SACA Overhead) File</h4>
	<form id ="data1" method="POST" action="overhead_upload_acn.php" enctype="multipart/form-data">
...
$("form#data1").submit(function(e) {
    ...
    $.ajax({
        ...
        url: 'http://localhost/excel_upload_single_table/saca_acnq.php',
