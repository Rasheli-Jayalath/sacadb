...
<body class="hold-transition sidebar-mini" onload="setTableSummaryFn();">
    <div class="wrapper">
        <!-- Navbar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <!-- top table -->
                        <div class="col-12" style="overflow: auto;">id="example1" class="table table-bordered table-striped"
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th style="width:200px"></th>
                                    <th style="width:100px;">Actual MTD</th>
                                    <th style="width:110px">MTD Forecast</th>
                                    <th style="width:100px">MTD Budget</th>
                                    <th style="width:120px">Yar. To Budget</th>
                                    <th style="width:150px">In % of Budget</th>
                                    <th style="width:100px">Actual YTD</th>
                                    <th style="width:120px">YTD Forecast</th>
                                ...
                                <tbody>                                <tr style="line-height: 0;background: #BBFFFD;">
                                    <td>Total Revenue</td>
                                    <td id="actualmtd1"></td>
                                    <td id="mtdforcast1"></td>
                                    <td id="mtdbudget1"></td>
                                    <td id="mtdyartobudget1"></td>
                                    <td id="mtdinpercenofbudget1"></td>
                                    <td id="actualytd1"></td>
                                    <td id="ytdforcast1"></td>
                                    <td id="ytdbudget1"></td>
                                ...
                                <tr style="line-height: 0;background: #77FFFC;">
                                    <td>Fee Revenue</td>
                                    <td id="actualmtd2"></td>
                                    <td id="mtdforcast2"></td>
                                    <td id="mtdbudget2"></td>
                                    <td id="mtdyartobudget2"></td>
                                    <td id="mtdinpercenofbudget2"></td>
                                    <td id="actualytd2"></td>
                                    <td id="ytdforcast2"></td>
                                    <td id="ytdbudget2"></td>
                                ...
                                <tr style="line-height: 0;background: #BBFFFD;">
                                    <td>Contribution </td>
                                    <td id="actualmtd3"></td>
                                    <td id="mtdforcast3"></td>
                                    <td id="mtdbudget3"></td>
                                    <td id="mtdyartobudget3"></td>
                                    <td id="mtdinpercenofbudget3"></td>
                                    <td id="actualytd3"></td>
                                    <td id="ytdforcast3"></td>
                                    <td id="ytdbudget3"></td>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-xl-4 col-lg-4 col-sm-4 border" style="height:250px;">
                            <canvas id="projectChartCounts"></canvas>
                        </div>
                        <div class="col-md-4 col-xl-4 col-lg-4 col-sm-4 border" style="height:250px;">
                            <canvas id="MTDFeeChartByRegion"></canvas>
                        </div>
                        <div class="col-md-4 col-xl-4 col-lg-4 col-sm-4 border" style="height:250px;">
                            <canvas id="MTDFeeChartBySector"></canvas>
                        </div>
                        <!-- <div class="col-md-4 col-xl-4 col-lg-4 col-sm-4 border" style="height:250px;">
                            MTDNWWByMarketChart
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-6 col-lg-6 col-sm-6 border" style="height:250px;">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-xl-4 col-lg-4 col-sm-4 border" style="height:350px;">
                            <canvas id="MonthlyPercenMTDFeeRevenueChart" style="max-height: 350px;"></canvas>
                        </div>
                        <div class="col-md-8 col-xl-8 col-lg-8 col-sm-8 border" style="height:350px;">
                            <canvas id="PPRChartRevenueVsContribution" style="max-height: 350px;"></canvas>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-xl-12 col-lg-12 col-sm-12 border" style="height:450px;">
                            <canvas id="SectorWiseYTDFeeByCountChart" style="max-height: 450px;"></canvas>
                        </div>
                    </div>
                    <!-- charts rows end -->
                </div><!-- /.container-fluid -->
    ...
    <script src="../../sacadb/theme/plugins/chart.js/Charts.Utiles.js"></script>
    <!-- AdminLTE App -->
