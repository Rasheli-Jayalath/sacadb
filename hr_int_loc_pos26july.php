                       ...
                       <tr>
                        ...
                        <?php 
                         $incListQueryk1  = "SELECT loss_non_mobilize as lnm FROM hr_int_pos WHERE month = (SELECT MAX(month) FROM hr_int_pos WHERE month < (SELECT MAX(month) FROM hr_int_pos) ) AND country ='".$incListRes['country']."' " ; 
                          ...
                          ?>
                          <td style="vertical-align: middle; text-align:center;"><?php if(isset($_POST['tbl1_filter_month'] ) && $_POST['tbl1_filter_month'] !== $min_month_res1['fst_month']){
                              if($incListCountk1 > 0) echo number_format($incListResk1['lnm']);  else{
                              echo 'No data';
                             }
                         }
                         else{
                     ...
                     <tr>
                        ...
                        <?php 
                         ...
                         if(isset($_POST['tbl2_filter_month'] ) && $_POST['tbl2_filter_month'] !== $min_month_res['fst_month']){
                          if($incListCountk > 0) echo number_format($incListResk['lnm1']);  else{
                          echo 'No data';
                         }
                         }
                         else{
