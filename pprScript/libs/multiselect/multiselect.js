  ...
  MultiSelect.prototype = {
    ...
    load: function () {
      ...
      $(instance.element).after(
        '<div class="ms-options-wrap"><button>None Selected</button><div class="ms-options"><ul style="list-style-type: none;padding:0;"></ul></div></div>'
      );
      ...
      optionsList
        ...
        .each(function (idx) {
          if (
            ...
            checkboxWidth = checkboxWidth ? checkboxWidth : 25;
