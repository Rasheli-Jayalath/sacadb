    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-color: #336992; color: white; ">
                <h3 class="card-title"><bold>International Positions: The current status as of Mar’23</bold></h3>
                ...
                <table class="table table-head-fixed text-nowrap">
                  <thead id="th">
                    <tr>
                      ...
                      <th style="vertical-align: middle; text-align:center;" id="th">Live Billable <br> Open Positions <br>   (FY’23) </th>
                      <th style="vertical-align: middle; text-align:center;" id="th">Positions Incurring <br> Revenue Loss <br>(FY’23)</th>
                      <th style="vertical-align: middle; text-align:center;" id="th">Loss due to <br> Non mobilization <br>(AUD)</th>
                      <th style="vertical-align: middle; text-align:center;" id="th">Billable Staff<br> mobilized <br> (FY’23)</th>
                  ...
                  <tbody>
                   ...
                   <?php if($con){
                        $incListQuery  = "SELECT *
                                         FROM hr_int_pos GROUP BY country
                                        ";   
                    }          
          ...
          <div class="row">
            ...
            <div class="card">
              <div class="card-header" style="background-color: #336992; color: white; ">
                <h3 class="card-title"><bold>Local Positions: The current status as of Mar’23</bold></h3>
                ...
                <table class="table table-head-fixed text-nowrap">
                  <thead id="th">
                    <tr>
                      ...
                      <th style="vertical-align: middle; text-align:center;" id="th">Staff Mobilized<br>(FY’23)</th>
                      <th style="vertical-align: middle; text-align:center;" id="th">Update</th>
                  ...
                  <tbody>
                   <?php if($con){
                        $incListQuery  = "SELECT *
                                         FROM hr_loc_pos GROUP BY country
                                        ";   
                    }          
                    $incListResult = mysqli_query($con,$incListQuery);
                    $incListCount  = mysqli_num_rows($incListResult);
