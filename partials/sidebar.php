    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <nav class="mt-2">
        ...
        <?php if($ppr==1 || $user_type==1)
		 ...
		 ($_SERVER['REQUEST_URI'] == '/sacadb/ppr_analysis.php?')||
         ...
         ($_SERVER['REQUEST_URI'] == '/sacadb/cash.php?'.$url_var)||
         ($_SERVER['REQUEST_URI'] == '/sacadb/overhead.php?'.$url_var)){
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="cash.php?<?php echo $url_var;?> " class="nav-link
                  <?php if($_SERVER['REQUEST_URI'] == '/sacadb/cash.php?'.$url_var){
                  echo "active";
                  }else echo" "?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cash Collection</p>
          ...
          <?php if($pmis==1 || $user_type==1)
		   ...
		   {?> 
             <!-- <li class="nav-item">
             <a href="hr_int_loc_pos.php" class="nav-link <?php if($_SERVER['REQUEST_URI'] == '/sacadb/hr_int_loc_pos.php'){
                  echo "active-main";
                  }else echo"active"?>">
             ...
             <li class="nav-item <?php if(($_SERVER['REQUEST_URI'] == '/sacadb/hr.php')||
                ($_SERVER['REQUEST_URI'] == '/sacadb/hr_int_loc_pos.php')
                ){
                  echo "menu-open";
                  }else echo""?>">
            <a href="" class="nav-link active">
          ...
          <?php if($user_type==1)
		   {?>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
<a href="sacadashboard_log.php" class="nav-link <?php if($_SERVER['REQUEST_URI'] == '/sacadb/sacadashboard_log.php'){
                  echo "active";
                  }else echo" "?>">
<i class="far fa-circle nav-icon"></i>
<p>SACA Dashboard Log</p>
</a>
</li>
<li class="nav-item">
<a href="update_status.php" class="nav-link <?php if($_SERVER['REQUEST_URI'] == '/sacadb/update_status.php'){
                  echo "active";
                  }else echo" "?>">
<i class="far fa-circle nav-icon"></i>
<p>DMS-PMIS Update Status</p>
</a>
</li>
