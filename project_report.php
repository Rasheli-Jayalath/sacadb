  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Vishnugad Pipalkothi HEP (444MW)</h1>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                     ...
                     <?php  $pmisUpdataDataQuery  = "SELECT * FROM `pmis_update_data` group by item_name ";
                     ...
                     ?>
                      ...
                      <td align="center">  <?php echo $pmisUpdataDataRes['item_name'];?></td>
                      
                      
                      <td align="center"> <?php echo $pmisUpdataDataRes['item_value1'];?></td>
                    ...
                    <!-- $pdSQL = "$pmisUpdataDataQuery  = "SELECT * FROM `pmis_update_data` "";
							$objSDb->dbQuery($pdSQL);
							  ...
							  {
								$counter=$counter+1;
								$rfi_activity_name=$pdData["rfi_activity_name"];
					 ?>
                              <tr>
                  					<td align="center" colspan="" class="" style=" text-transform:capitalize; background: #F6F6F6   ; ">
                                    <span style="font-size:16px"><?php echo $counter?></span></td>
