...
require 'partials/header.php'; ?> 
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="../../ppr/theme/index3.html" class="brand-link">
      <img src="../../ppr/theme/dist/img/smec-logo.png"
           alt="SJ-SMEC Logo" class="brand-image img-circle  elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">SMEC</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../../ppr/theme/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
