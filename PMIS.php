   ...
   <div class="col-md-4" id="report_section_single">
            <div class="card">
              <div class="card-header" id="card_header">
                <h3 class="card-title" id="card_header">PMIS Report</h3><?php if($uid==26){ ?><span style="text-align:right; font-size:10px; float:right"><a href="update_status.php?s=p" style="color:white; text-decoration:underline">Update Status</a></span><?php } ?>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
				  ...
				  $notupdated=$pmissumCount-$pmissumCount1;
				   if($u<=$countryCount)
                    ...
                    <tr>
                      ...
                      <td id="td-data">
                      <a onclick="detailpmis('<?php echo $country;?>','pt','1')" style=" cursor:pointer"> <?php echo $pmissumCount;?></a>
                        <!--<a href="pmis.php?c=<?php echo $country;?>&s=pt"><?php echo $pmissumCount;?></a>-->
                      
                      </td>
                      <td id="td-data"><span > <a onclick="detailpmis('<?php echo $country;?>','pu','1')" style=" cursor:pointer"><?php  echo $pmissumCount1;?></a></span></td>
                       <td id="td-data"><span > <a onclick="detailpmis('<?php echo $country;?>','pnu','1')" style=" cursor:pointer"><?php echo $notupdated;?></a></span></td>
                    </tr>
                    <?php
					$u++;
				   }
                   ...
                   <tr>
                      ...
                      <td id="td-data">
                        ...
                        <a onclick="detailpmis('all','pt','1')" style=" cursor:pointer"><?php echo $pmis_total;?></a>
                      
                      </td>
                      <td id="td-data"><span ><a onclick="detailpmis('all','pu','1')" style=" cursor:pointer"><?php  echo $pmis_total_updated;?></a></span></td>
                       <td id="td-data"><span ><a onclick="detailpmis('all','pnu','1')" style=" cursor:pointer"><?php echo $pmis_total_nupdated;?></a></span></td>
                    </tr>
          ...
          <div class="col-md-4" id="report_section_single">
            <div class="card">
              <div class="card-header"id="card_header-abcd">
                <h3 class="card-title"id="card_header-abcd">DMS Report</h3><?php if($uid==26){ ?><span style="text-align:right; font-size:10px; float:right"><a href="update_status.php?s=d" style="color:white; text-decoration:underline">Update Status</a></span><?php } ?>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <div class="form-group" >
				  ...
				  $notupdated=$dmssumCount-$dmssumCount1;
				   if($v<=$countryCountd)
                    ...
                    <tr>
                      ...
                      <td id="td-data">
                        ...
                        <a onclick="detaildms('<?php echo $country;?>','dt','1')" style=" cursor:pointer"><?php echo $dmssumCount;?></a>
                      
                      </td>
                      <td id="td-data"><span ><a onclick="detaildms('<?php echo $country;?>','du','1')" style=" cursor:pointer"><?php  echo $dmssumCount1;?></a></span></td>
                       <td id="td-data"><span ><a onclick="detaildms('<?php echo $country;?>','dnu','1')" style=" cursor:pointer"><?php echo $notupdated;?></a></span></td>
                    </tr>
                    <?php
					$v++;
				   }
                   ...
                   <tr>
                      ...
                      <td id="td-data">
                       ...
                       <a onclick="detaildms('all','dt','1')" style=" cursor:pointer"><?php echo $dms_total;?></a>
                      
                      </td >
                      <td id="td-data"><span ><a onclick="detaildms('all','du','1')" style=" cursor:pointer"><?php  echo $dms_total_updated;?></a></span></td>
                       <td id="td-data"><span ><a onclick="detaildms('all','dnu','1')" style=" cursor:pointer"><?php echo $dms_total_nupdated;?></a></span></td>
                    </tr>
				  ...
				  $notupdated=$gissumCount-$gissumCount1;
				   if($w<=$countryCountd)
                    ...
                    <tr>
                      ...
                      <td id="td-data">
                        ...
                        <a onclick="detailgis('<?php echo $country;?>','gt','1')" style=" cursor:pointer"><?php echo $gissumCount;?></a>
                      
                      </td>
                      <td id="td-data"><span ><a onclick="detailgis('<?php echo $country;?>','gu','1')" style=" cursor:pointer"><?php  echo $gissumCount1;?></a></span></td>
                       <td id="td-data"><span ><a onclick="detailgis('<?php echo $country;?>','gnu','1')" style=" cursor:pointer"><?php echo $notupdated;?></a></span></td>
                    </tr>
                    <?php
					$w++;
				   }
                   ...
                   <tr>
                      ...
                      <td id="td-data">
                         ...
                         <a onclick="detailgis('all','gt','1')" style=" cursor:pointer"><?php echo $gis_total;?></a>
                      
                      </td>
                      <td id="td-data"><span ><a onclick="detailgis('all','gu','1')" style=" cursor:pointer"><?php  echo $gis_total_updated;?></a></span></td>
                       <td id="td-data"><span ><a onclick="detailgis('all','gnu','1')" style=" cursor:pointer"><?php echo $gis_total_nupdated;?></a></span></td>
                    </tr>
