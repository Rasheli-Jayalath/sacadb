...
include("saveurl.php");
 ...
 $apps=$_POST['apps'];
  $samepage_log=$_POST['samepage_log'];
 
 
$sql_pstt="update direct_users set kpi=$kpi, ppr=$ppr,pmis=$pmis, cvbank=$cvbank,hr=$hr,software_portal=$software_portal,team_finder=$team_finder,bd_dashboard=$bd_dashboard,div_dms=$div_dms,eshs=$eshs,aibot=$aibot,photo_video=$photo_video,apps=$apps, samepage_log=$samepage_log where uid=$uid";
...
require 'partials/header.php'; ?> 
  ...
  <div class="content-wrapper">
    ...
    <td>&nbsp;</td>
		  ...
		  <tr>
    <td  align="right">&nbsp;</td>
    <td  width="130" valign="middle">Team Finder </td>
   ...
   <td  width="130" valign="middle">SAME Page Log</td>
    <td    ><select name="samepage_log" id="samepage_log" class="form-control form-control-sm"  style="width:80px; height:35px; background-color:#FFF; color:black">
      <option value="0" <?php if ($pmisrese['samepage_log']==0) {echo "selected='selected'";} ?>>Deny</option>
      <option value="1" <?php if ($pmisrese['samepage_log']==1) {echo "selected='selected'";} ?>>Allow</option>
    </select></td>
