        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xl-1 col-lg-3 col-sm-12">
                        <select class="custom-select" name="DDYear" id="DDYear">
                            <!-- <option value="%">All Month</option> -->
                        </select>
                    </div>
                    <div class="col-md-4 col-xl-1 col-lg-3 col-sm-12">
                        <input class="form-group" type="checkbox" value="0" id="isFX">
                        <label class="form-check-label" for="isFX">
                            Include FX
                        </label>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="overflow: auto;padding:0;">
                                <table class="table table-bordered table-striped ownTbl" id="analysisSummaryTableTop" style="table-layout: fixed;">
                                    ...
                                    <tr style="line-height: 0;background-color:#DAE1F5;">
                                        <td>Total Revenue</td>
                                        <td id="actualmtd1"></td>
                                    ...
                                    <tr style="line-height: 0;display:none;">
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;Overhead</td>
                                        <td id="actualmtd6"></td>
                                    ...
                                    <tr style="line-height: 0;" class="table-light">
                                        <td>Country OP</td>
                                        <td id="actualmtd61"></td>
                                        <td style="display:none;" id="mtdforcast61"></td>
                                        <td id="mtdbudget61"></td>
                                        <td id="mtdyartobudget61"></td>
                                        <td id="mtdinpercenofbudget61"></td>
                                        <td id="actualytd61"></td>
                                        <td style="display:none;" id="ytdforcast61"></td>
                                        <td id="ytdbudget61"></td>
                                        <td id="ytdyartobudget61"></td>
                                        <td id="ytdinpercenofbudget61"></td>
                                        <!-- <td id="eacbudget61"></td>
                                    <td id="eacforcast61"></td>
                                    <td id="straightlineprojection61"></td> -->
                                    </tr>
                                    <tr style="line-height: 0;background-color:#DAE1F5;">
                                        <td>Country OP%</td>
                                        <td id="actualmtd62"></td>
                                        <td style="display:none;" id="mtdforcast62"></td>
                                        <td id="mtdbudget62"></td>
                                        <td id="mtdyartobudget62"></td>
                                        <td id="mtdinpercenofbudget62"></td>
                                        <td id="actualytd62"></td>
                                        <td style="display:none;" id="ytdforcast62"></td>
                                        <td id="ytdbudget62"></td>
                                        <td id="ytdyartobudget62"></td>
                                        <td id="ytdinpercenofbudget62"></td>
                                        <!-- <td id="eacbudget6"></td>
                                    <td id="eacforcast6"></td>
                                    <td id="straightlineprojection6"></td> -->
                                    </tr>
                                    ...
                                    <tr style="line-height: 0;display:none;">
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;Overhead</td>
                                        <td id="actualmtd71"></td>
                                        <td style="display:none;" id="mtdforcast71"></td>
                                        <td id="mtdbudget71"></td>
                                        <td id="mtdyartobudget71"></td>
                                        <td id="mtdinpercenofbudget71"></td>
                                        <td id="actualytd71"></td>
                                        <td style="display:none;" id="ytdforcast71"></td>
                                        <td id="ytdbudget71"></td>
                                        <td id="ytdyartobudget71"></td>
                                        <td id="ytdinpercenofbudget71"></td>
                                        <!-- <td id="eacbudget71"></td>
                                    <td id="eacforcast71"></td>
                                    <td id="straightlineprojection71"></td> -->
                                    </tr>
                                    <tr style="line-height: 0;background-color:#DAE1F5;">
                                        <td>Final OP</td>
                                        <td id="actualmtd72"></td>
                                        <td style="display:none;" id="mtdforcast72"></td>
                                        <td id="mtdbudget72"></td>
                                        <td id="mtdyartobudget72"></td>
                                        <td id="mtdinpercenofbudget72"></td>
                                        <td id="actualytd72"></td>
                                        <td style="display:none;" id="ytdforcast72"></td>
                                        <td id="ytdbudget72"></td>
                                        <td id="ytdyartobudget72"></td>
                                        <td id="ytdinpercenofbudget72"></td>
                                        <!-- <td id="eacbudget72"></td>
                                    <td id="eacforcast72"></td>
                                    <td id="straightlineprojection72"></td> -->
                                    </tr>
                                    <tr style="line-height: 0;">
                                        <td>OP%</td>
                                        <td id="actualmtd73"></td>
                                        <td style="display:none;" id="mtdforcast73"></td>
                                        <td id="mtdbudget73"></td>
                                        <td id="mtdyartobudget73"></td>
                                        <td id="mtdinpercenofbudget73"></td>
                                        <td id="actualytd73"></td>
                                        <td style="display:none;" id="ytdforcast73"></td>
                                        <td id="ytdbudget73"></td>
                                        <td id="ytdyartobudget73"></td>
                                        <td id="ytdinpercenofbudget73"></td>
                                        <!-- <td id="eacbudget73"></td>
                                    <td id="eacforcast73"></td>
                                    <td id="straightlineprojection73"></td> -->
                                    </tr>
                                    <tr style="line-height: 0;display:none;">
                                    ...
                                    <tr style="line-height: 0;background-color:#DAE1F5;display:none;">
                                        <td>Net Contribution %</td>
                                        <td id="actualmtd9"></td>
                                    ...
                                    <tr style="line-height: 0;border-top:5px #b4b8bc solid" class="table-light">
                                        <td>WIP</td>
