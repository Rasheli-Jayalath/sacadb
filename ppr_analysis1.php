...
$projListQuery_srch  = "select *
                      FROM saca_project_master Where 1=1 ";
						  ...
						  $projListQuery_srch .= " AND master_code = '".$_REQUEST['project']."' ";
          ...
          <div class="col-12">
            <div class="card" >
              <div class="card-header"  style="background-color: #1d3a67; color: white; ">
                <h3 class="card-title" align="center" style="text-align:center"><bold><?php echo  $sub_project. " (".$totalProjectRes_srch["company"].")"."&nbsp;-&nbsp;".$totalProjectRes_srch["project_desc"];
				?></bold></h3>
                ...
                <table class="table table-striped text-nowrap">
                  <thead>
                    <tr>
                      ...
                      <th align="center">MTD Fees</th>
                      <th align="center">MTD Reimb </th>
                      <th align="center">MTD Total Rev</th>
                      <th align="center">MTD Salary Cost</th>
                      <th align="center">MTD Other Cost</th>
                      <th align="center">MTD Total Cost</th>
                      <th align="center">MTD Contrib</th>
                      <th align="center">MTD Contrib Margin</th>
                      <th align="center">LTD Billing</th>
                      <th align="center">WIP</th>
                      <th align="center">Debtor</th>
                      </tr>
                  </thead>
                  <tbody>
                    <?php  
                ...
                <table class="table table-head-fixed text-nowrap">
                  <thead>
                    <tr style="background-color: #79a9ce">
                      <th align="center" style="background-color: #79a9ce">&nbsp;</th>
