...
?>
				  ...
				  $pmiscon = "select distinct country_name as country_name from pmis_update_data order by country_name asc";
				   ...
				   while($pmisres=mysqli_fetch_assoc($pmisconres))
				   {
					   ...
					   $pmissum = "select project_id,country_name,max(item_value1) as max_date from pmis_update_data where country_name='$country' and item_name='GIS' group by project_id";
					   ...
					   $pmissum1 = "select project_id,country_name,max(item_value1) as max_date from pmis_update_data where item_value1>= now()-interval $smonth month and country_name='$country' and item_name='GIS' group by project_id";
