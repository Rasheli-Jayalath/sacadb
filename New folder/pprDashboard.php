                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xl-3 col-lg-3 col-sm-3">
                            <select class="custom-select" name="DDRegion" id="DDRegion">
                                <option value="%">All Region</option>
                            </select>
                        </div>
                        <div class="col-md-3 col-xl-3 col-lg-3 col-sm-3">
                            <select class="custom-select" name="DDSector" id="DDSector">
                        ...
                        <div class="col-md-1 col-xl-1 col-lg-1 col-sm-1">
                            <button type="button" onclick="searchLoadFn();" class="btn btn-success">SEARCH</button>
                        </div>
                        <div class="col-md-1 col-xl-1 col-lg-1 col-sm-1">
                            <button type="button" onclick="onloadFNs();" class="btn btn-secondary btn-sm">Reset</button>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
