                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th id="th-abcd">Project Name</th>
                     <th id="th-abcd">Country</th>
                    <th id="th-abcd">PMIS Link</th>
                    <th id="th-abcd">PMIS Last updated</th>
...
from pmis_update_data where item_name!='DMS' and item_name!='GIS' group by project_id";*/
		$pmisUpdataDataQuery  = "select project_id,project_name,links,country_name,max(item_value1) as max_date from pmis_update_data where item_name!='GIS' and item_name!='DMS'  group by project_id";
