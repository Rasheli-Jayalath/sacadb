...
?>
<tr><td >
<input type="checkbox" name="cmid_<?php echo $div_id?>_<?php echo $rid; ?>"  id="cmid_<?php echo $div_id?>_<?php echo $rid; ?>" value="<?php echo  $rid;?>" onchange="getccpid_p(<?php echo $div_id?>,<?php echo $rid; ?>)" /> <?=$res2['rname']; ?>
</td></tr>
<?php			
}			
