...
require 'partials/header.php'; ?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
             <iframe  scrolling="no" frameBorder="0" height="1000" width="1280" src="https://surbanajurong.sharepoint.com/sites/region-same/SitePages/Askaquestion.aspx"> </iframe> 
    </section>
    ...
    <section class="content">
      <div><h1>dfhtfhdfh</h1></div>
      <!-- <iframe src="https://india-sdms.smecnet.com/bdms/centralcvbank_k/rssfeed/rssfetch.php"></iframe> -->
      <div style="border: 2px solid #D5CC5A; overflow: hidden; margin: 15px auto; max-width: 575px;"> <iframe scrolling="no" src="https://india-sdms.smecnet.com/bdms/centralcvbank_k/rssfeed/rssfetch.php" style="border: 0px none; margin-left: -36px; height: 812px; margin-top: -486px; width: 650px;"> </iframe> </div>
    </section>
    <!-- /.content -->
  </div>
