...
if(!empty($_POST["Project_Type"]) && $_POST["Project_Type"]!="" ){ 
...
elseif(!empty($_POST["Project_Type"]) && $_POST["Project_Type"]!=0 && $_POST["Project_Type"]!="" && (empty($_POST["sid"]) || $_POST["sid"]==0 || $_POST["sid"]=="" || $_POST["sid"]=="undefined") && (empty($_POST["cid"]) || $_POST["cid"]==0 || $_POST["cid"]=="" || $_POST["cid"]=="undefined")&& (empty($_POST["rid"]) || $_POST["rid"]==0 || $_POST["rid"]=="" || $_POST["rid"]=="undefined")&& (empty($_POST["did"]) || $_POST["did"]==0 || $_POST["did"]=="" || $_POST["did"]=="undefined")){ 
   $incListQuery  = "select DISTINCT(smt.master_code), sp.Project_Description 
                       FROM saca_project_master as smt Inner Join saca_profitability as sp
          ON smt.project_code = sp.project Where 1=1 AND sp.Project_Type='".$_POST["Project_Type"]."' order by sp.project ASC ";
