        ...
        <div class="content-wrapper">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xl-2 col-lg-2 col-sm-12">
                            <span style="font-size:12px;">All Figures In AUD</span>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
            ...
            <section class="content">
                <div class="container-fluid">
                            ...
                            <table class="table table-bordered table-striped ownTbl" id="analysisSummaryTableTop"
                                ...
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th style="width:110px">YTD Forecast</th>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xl-12 col-lg-12 col-sm-12 border" style="height:350px;">
                            <canvas id="SectorWiseYTDFeeByCountChart" style="max-height: 350px;"></canvas>
                        </div>
                    </div>
                    <!-- charts rows end -->
                </div><!-- /.container-fluid -->
