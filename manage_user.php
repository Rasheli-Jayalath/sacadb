...
<?php
  ...
  opacity:.3;
                        ...
                        <?php /*?><td><?php  if(($pmisres['active']==1) && ($pmisres['user_type']==1))
				{
					echo "Full Rights";}else if(($pmisres['active']==1) && ($pmisres['user_type']!=1)){?>
                  <a href="pages_rights.php?id=<?php echo  $pmisres['uid']?>">Pages Rights</a> <?php			}
				?></td><?php */?>
				...
				<td><?php  if(($pmisres['active']==1) && ($pmisres['user_type']==1))
				{
					...
					else if(($pmisres['active']==1) && ($pmisres['user_type']!=1))
					{?>
                  		<a href="pages_rights.php?id=<?php echo  $pmisres['uid']?>">Pages Rights</a> 
						  <?php
                          if($pmisres['ppr']==1 ){	
						
						?>
                        <!-- | <a href="assign_rights.php?id=<?php echo  $pmisres['uid']?>" <?php echo $class;?>>PPR Rights</a>-->
<?php
}
 }
