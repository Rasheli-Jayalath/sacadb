...
$sql_lis31="select distinct country from saca_project_master where division=$div_id and region=$region_id";
...
--><input type="checkbox" name="country_arr[]"  id="cmid_<?php echo $div_id?>_<?php echo $region_id; ?>_<?php echo $country_id; ?>" value="<?php echo $div_id?>_<?php echo $region_id; ?>_<?php echo  $country_id;?>" onchange="getproject_p(<?php echo $div_id; ?>,<?php echo $region_id; ?>,<?php echo $country_id; ?>)" /> <?=$resultc['cname']; ?>
